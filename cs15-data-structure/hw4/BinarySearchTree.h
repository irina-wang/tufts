...
private:
        ...
        // helper functions
        int return_larger_one_of(int left_result, int right_result) const;
        void update_parent(Node *parent, Node *node, Node *update_to);
        Node *newNode(int data, int count, Node *left, Node *right) const;
};
